## - The original model does not run on cpu, this a forked version that does
## - In addition to that it utilizes the openvino and onnx framework for inference
## - So far, the image infernece is the one that works, however after the conversion, refactoring the the rest is a bit easier
## - Check out the openvino github repo for installation issues [OpenVino GitHub Repo](https://github.com/openvinotoolkit/openvino_notebooks)
<br> <br>
...
# Installation
 - Clone this repository and enter it:
   ```Shell
   git clone https://github.com/Abdullah-Elkasaby/yolact-image-segmentation-demo-using-openvino-and-onnx.git
   cd yolact
   ```
