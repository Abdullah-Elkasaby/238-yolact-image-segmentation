...
if __name__ == '__main__':
    ...
    args.top_k=15
    args.image="test2.jpg:output_image.jpg"
    ...
    with torch.no_grad():
        ...
        # evalimage(net, "test_img.jpg", "out.jpg")
        # evalimage(net, "weights/yolact_base_54_800000.pth", "image=test_img.jpg:output_image.jpg")
